    ...
    <div class="aside-menu flex-column-fluid">
        ...
        <div class="hover-scroll-overlay-y my-5 my-lg-5" id="kt_aside_menu_wrapper" data-kt-scroll="true"
            ...
            <div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500"
                ...
                <div class="menu-item">
                    <a class="menu-link {{ Request::segment(2) == 'presenters' ? 'active' : '' }}"
                        href="{{ route('admin.presenters.index') }}">
                        <span class="menu-icon">
                            <!--begin::Svg Icon | path: icons/duotone/Design/PenAndRuller.svg-->
                            <span class="svg-icon svg-icon-2">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" viewBox="0 0 24 24"
                ...
                <div class="menu-item">
                    <a class="menu-link {{ Request::segment(2) == 'shows' ? 'active' : '' }}"
                ...
                <div class="menu-item">
                    <a class="menu-link {{ Request::segment(2) == 'musice-basket' ? 'active' : '' }}"
                        href="{{ route('admin.musice-basket.index') }}">
                        <span class="menu-icon">
                            <!--begin::Svg Icon | path: icons/duotone/Design/PenAndRuller.svg-->
                            <span class="svg-icon svg-icon-2">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" viewBox="0 0 24 24"
                ...
                <div class="menu-item">
                    <a class="menu-link {{ Request::segment(2) == 'videos' ? 'active' : '' }}"
                ...
                <div class="menu-item">
                    <a class="menu-link {{ Request::segment(2) == 'ads' ? 'active' : '' }}"
