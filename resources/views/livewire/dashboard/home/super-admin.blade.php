                    ...
                    <div class="col-xl-4">
                        ...
                        <a href="#" class="card bg-dark hoverable card-xl-stretch mb-xl-8">
                            ...
                            <div class="card-body">
                                ...
                                <!--end::Svg Icon-->
                                <div class="text-inverse-dark fw-bolder fs-2 mb-2 mt-5">{{ $totalVideos }}</div>
                                <div class="fw-bold text-inverse-dark fs-7">{{ __('Total Videos') }}</div>
                            </div>
                            <!--end::Body-->
                        </a>
                    ...
                    <div class="col-xl-4">
                        ...
                        <a href="#" class="card bg-warning hoverable card-xl-stretch mb-xl-8">
                            ...
                            <div class="card-body">
                                ...
                                <!--end::Svg Icon-->
                                <div class="text-inverse-warning fw-bolder fs-2 mb-2 mt-5">{{ $totalShows }}</div>
                                <div class="fw-bold text-inverse-warning fs-7">{{ __('Total Shows') }}</div>
                            </div>
                            <!--end::Body-->
                        </a>
                        <!--end::Statistics Widget 5-->
                    ...
                    <div class="col-xl-4">
                        ...
                        <a href="#" class="card bg-info hoverable card-xl-stretch mb-5 mb-xl-8">
                            ...
                            <div class="card-body">
                                ...
                                <!--end::Svg Icon-->
                                <div class="text-inverse-info fw-bolder fs-2 mb-2 mt-5">{{ $totalPresneters }}</div>
                                <div class="fw-bold text-inverse-info fs-7">{{ __('Total Presneters') }}</div>
                            </div>
                            <!--end::Body-->
                        </a>
                        <!--end::Statistics Widget 5-->
                                    ...
                                    <tbody>
                                        @foreach ($latestUsers as $last)
                                            <tr>
                                                ...
                                                <td>
                                                    <span class="text-muted fw-bold">{{ $last->ip }}</span>
                                                </td>
                                                <td>
                                                    <span class="text-muted fw-bold">{{ $last->type }}</span>
                                                </td>
                                                <td>
                                                    <span
                                                        class="text-muted fw-bold">{{ $last->created_at->diffForHumans() }}</span>
                                                </td>
                                            </tr>
                                        @endforeach
                                    </tbody>
