                ...
                <div class="card-body border-top p-9">
                        ...
                        <div class="col-lg-8">
                            <div class="row">
                                <div class="col-lg-12 fv-row">
                                    <x-input type="text" field="presenter.name" wire:model="presenter.name" placeholder="name" />
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row mb-6">
                        ...
                        <div class="col-lg-8">
                            <div class="row">
                                <div class="col-lg-12 fv-row">
                                    <x-input type="text" field="presenter.description" wire:model="presenter.description" placeholder="description" />
                                </div>
                            </div>
                        </div>
                    </div>
                    <!--end::Input group-->
                     <!--begin::Input group-->
                    <div class="row mb-6">
                        <x-label class="required">{{__("Priorty")}}</x-label>
                        <div class="col-lg-8">
                            <div class="row">
                                <div class="col-lg-12 fv-row">
                                    <x-input type="text" field="presenter.priorty" wire:model="presenter.priorty" placeholder="priorty" />
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row mb-0">
                        ...
                        <div class="col-lg-8 d-flex align-items-center">
                            <div class="col-12" x-data="{ isUploading: false, progress: 0 }"
                                ...
                                @elseif($presenter->image)
                                <div class="symbol symbol-150 mt-5">
                                    <img alt="" src="{{ asset($presenter->image) }}" />
                                </div>
                                @endif
                            </div>
                        </div>
