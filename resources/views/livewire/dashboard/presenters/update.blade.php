                ...
                <div class="card-body border-top p-9">
                        ...
                        <div class="col-lg-8">
                            <div class="row">
                                <div class="col-lg-12 fv-row">
                                    <x-input type="text" field="presenter.name" wire:model="presenter.name"
                                        placeholder="name" />
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row mb-6">
                        ...
                        <div class="col-lg-8">
                            <div class="row">
                                <div class="col-lg-12 fv-row">
                                    <x-input type="text" field="presenter.description"
                                        wire:model="presenter.description" placeholder="description" />
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row mb-6">
                        ...
                        <div class="col-lg-8">
                            <div class="row">
                                <div class="col-lg-12 fv-row">
                                    <x-input type="number" field="presenter.priorty" wire:model="presenter.priorty"
                                        placeholder="priorty" />
                                </div>
                            </div>
                        </div>
