...
Route::group(['prefix' => 'admin','as' => 'admin.','middleware'=>'auth'], function () {
    ...
    Route::resource('musice-basket', App\Http\Controllers\Dashboard\MusicBasketController::class);
    Route::resource('ads', App\Http\Controllers\Dashboard\AdsController::class);
